...
namespace PEPE
{
	...
	public:
		...
		static inline void ApplyPerkEntryPoint(SkyrimVM* a_vm, RE::VMStackID a_stackID, RE::StaticFunctionTag*,
			RE::Actor* target, RE::BSFixedString entry_point, std::vector<RE::TESForm*> args, RE::BSFixedString category, int32_t channel)
		{
			logger::info("hit");
		...
		static inline float ApplyPerkEntryPointFloat(SkyrimVM* a_vm, RE::VMStackID a_stackID, RE::StaticFunctionTag*,
			RE::Actor* target, RE::BSFixedString entry_point, std::vector<RE::TESForm*> args, float base_value, RE::BSFixedString category, int32_t channel)
		{
		...
		static inline RE::BSFixedString ApplyPerkEntryPointString(SkyrimVM* a_vm, RE::VMStackID a_stackID, RE::StaticFunctionTag*,
			RE::Actor* target, RE::BSFixedString entry_point, std::vector<RE::TESForm*> args, RE::BSFixedString or_value, RE::BSFixedString category, int32_t channel)
		{
